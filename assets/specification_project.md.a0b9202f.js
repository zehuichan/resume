...
<span class="line"><span style="color:#A6ACCD;">    │</span></span>
<span class="line"><span style="color:#A6ACCD;">    └─pages(views) # 页面</span></span></code></pre></div><h2 id="taro-vue3-架构" tabindex="-1">Taro + Vue3 架构 <a class="header-anchor" href="#taro-vue3-架构" aria-label="Permalink to &quot;Taro + Vue3 架构&quot;">​</a></h2><p>仅适用于 <code>小程序</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">root:.</span></span>
